            ...
            <Menu gutter={0}>
              ...
              <MenuList borderRadius="0px">
                <MenuOptionGroup onChange={handleFiltering} title='Filter' type='radio'>
                  ...
                  <MenuItemOption value='Auric'>Auric</MenuItemOption>
                  <MenuItemOption value='GBR'>GBR</MenuItemOption>
                  ...
                  <MenuItemOption value='Pantanjali'>Pantanjali</MenuItemOption>
                  <MenuItemOption value='AKSHAYAKALPA'>AKSHAYAKALPA</MenuItemOption>
                  <MenuItemOption value='Milky Mist'>Milky Mist</MenuItemOption>
                  <MenuItemOption value='Aashirvaad Svasti'>Aashirvaad Svasti</MenuItemOption>
                </MenuOptionGroup>
              </MenuList>
            </Menu>
